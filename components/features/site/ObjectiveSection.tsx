...
export default function ObjectiveSection() {
  return (
    <section className="py-16 bg-base-100" id="objectif">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          <motion.p variants={fadeInUp}>
            ...
            espèces d'oiseaux à partir d'enregistrements sonores et d'une base
            de données ?
          </motion.p>
          <motion.p variants={fadeInUp}>
          ...
          <motion.p variants={fadeInUp}>
            ...
            sur la base de données fournies par GEPOG. Les données validées sont
